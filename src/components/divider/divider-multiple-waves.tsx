...
type T_DividerMultipleWaves = Omit<IDivider.IProps, "invert">;

const DividerMultipleWaves: React.FC<T_DividerMultipleWaves> = ({
  position = "top",
  flip = false,
  height,
  width,
...
export default memo(DividerMultipleWaves);
